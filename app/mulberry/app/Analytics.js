...
/**
 * mulberry.app.Analytics listens for the broadcast of application events
 * and tracks them in Flurry analytics as appropriate.
 */
(function(){

var _pg = mulberry.app.PhoneGap;

dojo.declare('mulberry.app.Analytics', [], {
  /**
   * @constructor
  ...
  _trackPageview : function(hash) {
    _pg.analytics.log('/tour/' + mulberry.app.Config.get('app').id + hash);
  },
