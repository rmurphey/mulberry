...
(function() {
  var mulberryRoutes = (function() {
    ...
    function appBackgroundImage() {
      if (!appBgImg) {
        ...
        if (appBgImg) {
          ...
          appBgImg = appBgImg ? mulberry.app.Data.getModel(appBgImg, 'backgroundImage')[
    ...
    function nodeRoute(route, nodeId, pageState) {
      ...
      var nodeModel = mulberry.app.Data.getModel(nodeId),
    ...
    routes = [
...

      {
        ...
        handler : function(params) {
          ...
          page = mulberry.createPage({
            pageDef : 'search',
            term : term,
            getResults : dojo.hitch(mulberry.app.Data, 'search'),
...

      {
        ...
        handler : function(params) {
          var feed = mulberry.app.Data.getModel(params.feedId, 'feed'),
      ...
      routes.push({
        ...
        handler : function() {
          var page = mulberry.createPage({
            ...
            pageDef : 'favorites',
            favorites : mulberry.app.user.Favorites.load(),
            backgroundImage : appBackgroundImage()
          });
  ...
  mulberry.routes(mulberryRoutes);
