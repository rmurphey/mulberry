...
dojo.provide('mulberry.app.user.Twitter');
...
dojo.declare('mulberry.app.user.Twitter', [], {
  ...
  setUserInfo : function(u) {
    console.log('mulberry.app.user.Twitter::setUserInfo()');
  ...
  isAuthenticated : function() {
    console.log('mulberry.app.user.Twitter::isAuthenticated()');
  ...
  postMessage : function(msg) {
    console.log('mulberry.app.user.Twitter::postMessage()');
  ...
  _postMessage : function(msg, t) {
    ...
    console.log('mulberry.app.user.Twitter::_postMessage()');

    var postRequest = new mulberry.app.user._TwitterAPI({
  ...
  _getAuthTokenFields : function() {
    console.log('mulberry.app.user.Twitter::_getAuthTokenFields()');
  ...
  _getAuth :  function() {
    console.log('mulberry.app.user.Twitter::_getAuth()');
    ...
    authRequest = new mulberry.app.user._TwitterAPI({
      customerKey : this.twitterConfig.customerKey,
      consumerSecret : this.twitterConfig.customerSecret
    });
...
dojo.declare('mulberry.app.user._TwitterAPI', null, {
