dojo.provide('mulberry.components.AssetList');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.AssetList', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'AssetList/AssetList.haml'),
  "class" : 'assets',
