dojo.provide('mulberry.components.AudioPlayer');

dojo.require('mulberry.app.PhoneGap');
dojo.require('mulberry.components._MediaPlayer');

dojo.declare('mulberry.components.AudioPlayer', mulberry.components._MediaPlayer, {
  templateString : dojo.cache('mulberry.components', 'AudioPlayer/AudioPlayer.haml'),
