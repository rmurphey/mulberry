dojo.provide('mulberry.components.BodyText');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.BodyText', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'BodyText/BodyText.haml'),
