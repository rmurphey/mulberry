dojo.provide('mulberry.components.FeedItemDetail');

dojo.require('mulberry._Component');
dojo.require('dojo.date.locale');

dojo.declare('mulberry.components.FeedItemDetail', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'FeedItemDetail/FeedItemDetail.haml'),
  itemTemplate : Haml(dojo.cache('mulberry.components', 'FeedItemDetail/Item.haml')),
