dojo.provide('mulberry.components.FeedItemList');

dojo.require('mulberry._Component');
dojo.require('dojo.date.locale');
dojo.require('mulberry.Utilities');

dojo.declare('mulberry.components.FeedItemList', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'FeedItemList/FeedItemList.haml'),
  itemTemplate : Haml(dojo.cache('mulberry.components', 'FeedItemList/FeedItem.haml')),
