dojo.provide('mulberry.components.GoogleMap');
...
(function (dojo) {
  ...
  dojo.declare('mulberry.components.GoogleMap', mulberry._Component, {
    templateString : dojo.cache('mulberry.components', 'GoogleMap/GoogleMap.haml'),
    ...
    _showInfo : function (/** google.maps.Marker */ marker, /** mulberry.models.GoogleMapPin */ pin) {
      var infoWindow;
