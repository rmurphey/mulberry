dojo.provide('mulberry.components.HeaderImage');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.HeaderImage', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'HeaderImage/HeaderImage.haml'),
