dojo.provide('mulberry.components.Hotspots');

dojo.require('mulberry._Component');
dojo.require('mulberry.ui.BackgroundImage');

dojo.declare('mulberry.components.Hotspots', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'Hotspots/Hotspots.haml'),
  ...
  _handleImageClick : function(e) {
    ...
    if (foundSpot) {
      ...
      mulberry.app.Router.go(mulberry.app.URL.node(foundSpot.node_id));
    }
  },
