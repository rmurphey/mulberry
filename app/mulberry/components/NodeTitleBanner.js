dojo.provide('mulberry.components.NodeTitleBanner');

dojo.require('mulberry._Component');
dojo.require('mulberry.ui.BackgroundImage');

dojo.declare('mulberry.components.NodeTitleBanner', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'NodeTitleBanner/NodeTitleBanner.haml'),
