dojo.provide('mulberry.components.SearchInput');

dojo.require('mulberry._Component');
dojo.require('mulberry.components.buttons.BackButton');

dojo.declare('mulberry.components.SearchInput', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'SearchInput/SearchInput.haml'),
  _oldValue : null,
