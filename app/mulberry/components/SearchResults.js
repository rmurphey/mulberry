dojo.provide('mulberry.components.SearchResults');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.SearchResults', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'SearchResults/SearchResults.haml'),
  resultTemplate : Haml(dojo.cache('mulberry.components', 'SearchResults/Result.haml')),
  ...
  _setResultsAttr : function(results) {
    if (results && !dojo.isArray(results)) {
      throw new Error('mulberry.components.SearchResults::_setResultsAttr: results argument must be an array');
    }
