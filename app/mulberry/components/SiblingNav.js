dojo.provide('mulberry.components.SiblingNav');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.SiblingNav', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'SiblingNav/SiblingNav.haml'),
  siblingTemplate : Haml(dojo.cache('mulberry.components', 'SiblingNav/Sibling.haml')),
