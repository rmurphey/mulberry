dojo.provide('mulberry.components.SocialMessage');

dojo.require('mulberry._Component');

dojo.declare('mulberry.components.SocialMessage', mulberry._Component, {
  templateString : dojo.cache('mulberry.components', 'SocialMessage/SocialMessage.haml'),
  ...
  onCancel : function() {
    console.log('mulberry.components.SocialMessage::onCancel()');
  },
