dojo.provide('mulberry.components.VideoPlayer');

dojo.require('mulberry.components._MediaPlayer');
/*
 ...
 * taps on it.
 */
dojo.declare('mulberry.components.VideoPlayer', mulberry.components._MediaPlayer, {
  templateString : dojo.cache('mulberry.components', 'VideoPlayer/VideoPlayer.haml'),
