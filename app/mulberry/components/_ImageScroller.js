dojo.provide('mulberry.components._ImageScroller');

dojo.require('vendor.iscroll');
dojo.require('mulberry.components._ImageGallery');

/**
 * This is a mixin to be used with components that include
 * an image scroller. It should not be used on its own.
 */
dojo.declare('mulberry.components._ImageScroller', mulberry.components._ImageGallery, {
  templateString : dojo.cache('mulberry.components', '_ImageScroller/ImageScroller.haml'),
  ...
  onScrollerSetupComplete : function() {
    console.log('mulberry.components._ImageScroller::onScrollerSetupComplete()');
