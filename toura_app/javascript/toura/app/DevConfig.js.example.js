...
toura.features.debugToolbar = true; // The makes resetting the DB and using weinre easier
toura.features.debugPage = true; // Type 'toura:<anything> in search will provide debugging info
...
toura.features.socialInBrowser = true; // To simulate social features in the browser
